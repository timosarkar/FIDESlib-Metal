...
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
    tparams64_13_1_flex{tparams64_13_1, lbcrypto::ScalingTechnique::FLEXIBLEAUTOEXT};
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
    tparams64_13_1_fix{tparams64_13_1, lbcrypto::ScalingTechnique::FIXEDAUTO};
...
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
    tparams64_13_2_flex{tparams64_13_2, lbcrypto::ScalingTechnique::FLEXIBLEAUTOEXT};
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
...
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
    tparams64_13_3_flex{tparams64_13_3, lbcrypto::ScalingTechnique::FLEXIBLEAUTOEXT};
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
...
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
    tparams64_13_4_flex{tparams64_13_4, lbcrypto::ScalingTechnique::FLEXIBLEAUTOEXT};
inline std::tuple<std::tuple<GeneralTestParams, FIDESlib::CKKS::Parameters>, lbcrypto::ScalingTechnique>
...
#define TTALL64                                                                                        \
    tparams64_13_fix, tparams64_13_fixauto, tparams64_13_flex, tparams64_13_flexext, tparams64_14_fix, \
        tparams64_16_boot1_flex, tparams64_16_boot1_flexext
//,          \
...
#define ASSERT_EQ_CIPHERTEXT(ct1, ct2)                                                                    \
    do {                                                                                                  \
        ...
        for (size_t j = 0; j < 2; ++j) {                                                                  \
            ASSERT_EQ(ct1.get()->GetElements().at(j).GetAllElements().size(),                             \
                      ct2.get()->GetElements().at(j).GetAllElements().size());                            \
            for (size_t i = 0; i < ct1.get()->GetElements().at(j).GetAllElements().size(); ++i) {         \
                ...
                ASSERT_EQ(ct1.get()->GetElements().at(j).GetAllElements().at(i).GetValues(),              \
                          ct2.get()->GetElements().at(j).GetAllElements().at(i).GetValues());             \
            }                                                                                             \
        }                                                                                                 \
        std::cout << std::endl;                                                                           \
    } while (0);
